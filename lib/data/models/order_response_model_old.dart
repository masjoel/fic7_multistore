...
class OrderResponseModelOld {
  final Data data;

  OrderResponseModelOld({
    required this.data,
  });

  factory OrderResponseModelOld.fromJson(String str) =>
      OrderResponseModelOld.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory OrderResponseModelOld.fromMap(Map<String, dynamic> json) =>
      OrderResponseModelOld(
